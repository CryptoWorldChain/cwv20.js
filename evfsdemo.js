...
async function reqUpload(){
    ...
    let args = { 
        ...
        "slices":1,
        "tos":["533a5a084cd587c86c20a0ddfb28f9ad018f341a"],
        "values":["0x0"],
...
let authorization=function(){
    let args = { 
        "nodeUuid":"0xd166fbdcfa85036d066fca72cb68c2abf1ee24f03c64aa7113ea83fa73787110",
        "tos":["0x065a4c2d46edb9344dd50f42cad551b5799d3460"]
    }
...
let updatePrice=function(){
    let args = { 
        "nodeUuid":"0xb32ff972181924f98c2c65f04b385d38f168d26b08e4e6214a809dfd1bba16a4",
        "licenseFee":"20000000000000000000",
        "licensePrice":"200000000000000000000"
    }
    chain.rpc.getBalance(from.keypair.hexAddress).then(function(result){
        result=JSON.parse(result);
        from.keypair.nonce=result.nonce;
...
let download=async function(){
    ...
    let nodeuuid='0x8ad70c81188da8d8ac42566337af460d6de2c2a78b6797bc0d0764d3b4bd0f54';
...
let nodeid='0xb32ff972181924f98c2c65f04b385d38f168d26b08e4e6214a809dfd1bba16a4';
